      ...
      return (
        <div className={prefix('container')}>
          <div className={prefix('header')}>
            <Icon className={prefix('header-icon')} component={screen.isLittleScreen ? updateMobile as any : update as any} />
          ...
          <div className={prefix('footer')}>
            <Button className={prefix('footer-btn')} type="primary" loading={btnLoading} onClick={handleResetPassword}>确认修改</Button>
            <Link className={prefix('footer-back')} to="/">返回首页</Link>
          </div>
        </div>
      );
    } else {
      return (
        <div className={prefix('invalid')}>
          ...
          <div className={prefix('invalid-back')}>
            <Icon component={screen.isLittleScreen ? backHomeMobile as any : backHome as any} className={prefix('invalid-back-icon')} />
            <div className={prefix('invalid-back-text')}>该链接已失效或者过期，您可以选择：</div>
          </div>
          <Link className={prefix('invalid-btn')} to="/">返回首页</Link>
        </div>
      )
    }
  }
